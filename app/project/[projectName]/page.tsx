      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg border border-slate-200 dark:border-gray-700">
            <div className="text-sm text-slate-600 dark:text-gray-400">Total Files</div>
            <div className="text-3xl font-bold text-gray-900 dark:text-gray-100">{project.stats.files}</div>
          </div>
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg border border-slate-200 dark:border-gray-700">
